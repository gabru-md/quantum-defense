...
const gameConfig: Phaser.Types.Core.GameConfig = {
    ...
    width: 1920,
    height: 1080,
    scene: [MenuScene, Introduction, CreditsScene, Tutorial, Level1, Level2, Level3, Level4, Level5, WinScene, StoryLevel1, StoryLevel2, StoryLevel3, StoryLevel4, StoryLevel5],
    physics: {
        default: 'arcade',
        arcade: {
            gravity: {
